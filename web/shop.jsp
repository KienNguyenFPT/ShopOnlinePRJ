            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <!-- Load all categories to sever -->
                        <c:forEach items="${listC}" var="o">
                            <li>
                                <a href="category?cid=${o.category_id}" class="nav-item nav-link">${o.cname}</a>
                            </li>
                        </c:forEach>
    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">F</span>Fashion</h1>
                </a>
                <p>Specializes in providing trendy models, enhancing your beauty</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Quy Nhon City, Binh Dinh Province, Viet Nam</p>
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>fashionk17fptu@gmail.com</p>
                <p class="mb-0"><i class="fa fa-phone-alt text-primary mr-3"></i>+84 964 641 839</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>About our system</a>
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Recruitment</a>
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Privacy Policy</a>
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Genuine</a>
                            <a class="text-dark mb-2" href=""><i class="fa fa-angle-right mr-2"></i>Flash sales</a>
                            <a class="text-dark" href=""><i class="fa fa-angle-right mr-2"></i>Contact with us</a>
                        </div>
                    </div>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    ...
                    Distributed By <a href="https://www.facebook.com/hello.trungkien2711/" target="_blank">GROUP 2 SE17B02 K17 FPTU</a>
                </p>
            </div>
